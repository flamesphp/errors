...
namespace Flames\Errors;

use Flames\Errors\Exception\ErrorException;
use Flames\Errors\Handler\CallbackHandler;
use Flames\Errors\Handler\Handler;
use Flames\Errors\Handler\HandlerInterface;
use Flames\Errors\Inspector\InspectorFactory;
use Flames\Errors\Inspector\InspectorFactoryInterface;
use Flames\Errors\Inspector\InspectorInterface;
use Flames\Errors\Util\Misc;
use Flames\Errors\Util\SystemFacade;
...
final class Run implements RunInterface
{
    ...
    public function register()
    {
        if (!$this->isRegistered) {
            ...
            class_exists("\\Flames\\Errors\\Exception\\ErrorException");
            class_exists("\\Flames\\Errors\\Exception\\FrameCollection");
            class_exists("\\Flames\\Errors\\Exception\\Frame");
            class_exists("\\Flames\\Errors\\Exception\\Inspector");
            class_exists("\\Flames\\Errors\\Inspector\\InspectorFactory");
    ...
    /**
     * Unregisters all handlers registered by this Errors\Run instance.
     *
     * @return Run
     */
    ...
    /**
     * Should Errors allow Handlers to force the script to quit?
     *
     * @param bool|int $exit
     *
     * @return bool
    ...
    /**
     * Should Errors send HTTP error code to the browser if possible?
     * Errors will by default send HTTP code 500, but you may wish to
    ...
    /**
     * Should Errors exit with a specific code on the CLI if possible?
     * Errors will exit with 1 by default, but you can specify something else.
     *
     * @param int $code
     *
     * @return int
    ...
    /**
     * Should Errors push output directly to the client?
    ...
    /**
     * Handles an exception, ultimately generating a Errors error page.
     *
    ...
    public function handleError($level, $message, $file = null, $line = null)
    {
        if ($level & $this->system->getErrorReportingLevel()) {
            ...
            // Do not propagate errors which were already handled by Errors.
            return true;
        }
    ...
    private function resolveHandler($handler)
    {
        ...
        if (!$handler instanceof HandlerInterface) {
            throw new InvalidArgumentException(
                ...
                . "Errors\\Handler\\HandlerInterface"
            );
        }
