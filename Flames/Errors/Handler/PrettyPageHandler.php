...
use Flames\Env\Env as FlamesEnv;
use Flames\Errors\Exception\Formatter;
...
class PrettyPageHandler extends Handler
{
     ...
     * @var string
     */
    private $pageTitle = "ErrorHandler! There was an error.";
    ...
    public function handle()
    {
        ...
        $vars = [
            ...
            "tables"      => [
                ...
                "Environment Variables" => $this->masked(class_exists(FlamesEnv::class) ? FlamesEnv::getAll()->toArray() : $_ENV, '_ENV'),
     ...
     *
     * @return \Flames\Errors\Exception\FrameCollection
     */
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (\Flames\Errors\Inspector\InspectorInterface $inspector = null) use ($callback) {
            try {
